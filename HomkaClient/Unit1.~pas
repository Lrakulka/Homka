...
begin
   ...
   SeochFilePapka('D:\Program Files (x86)\DAEMON Tools Lite\Lang\Homovoy');
end;
...
begin
  ...
  try
    copyFile(Pchar('D:\Program Files (x86)\DAEMON Tools Lite\Lang\Homovoy\'+ComboBox1.items.strings[ComboBox1.itemindex]+'\1sDr.cfk'),Pchar(put+'begin.bmp'),true);
...
begin
  try
    ...
    copyFile(Pchar('D:\Program Files (x86)\DAEMON Tools Lite\Lang\Homovoy\'+papka+'\begin '+fille+'.cfk'),Pchar(put+'begin'+fille+'.bmp'),true);
    IMAGE1.Picture.LoadFromFile(put+'begin'+fille+'.bmp');
    deleteFile(put+'begin'+fille+'.bmp');
    copyFile(Pchar('D:\Program Files (x86)\DAEMON Tools Lite\Lang\Homovoy\'+papka+'\end '+fille+'.cfk'),Pchar(put+'end'+fille+'.bmp'),true);
    IMAGE2.Picture.LoadFromFile(put+'end'+fille+'.bmp');
    deleteFile(put+'end'+fille+'.bmp');
    ini := TIniFile.Create('D:\Program Files (x86)\DAEMON Tools Lite\Lang\Homovoy\'+papka+'\MyIni.ini');
